...
public class ElasticsearchTweetController {
    ...
    public static class AddTweetsTask extends AsyncTask<NormalTweet, Void, Void> {
        ...
        protected Void doInBackground(NormalTweet... tweets) {
            ...
            for (NormalTweet tweet : tweets) {
                Index index = new Index.Builder(tweet).index("testing").type("tweet_test").build();
    ...
    public static class GetTweetsTask extends AsyncTask<String, Void, ArrayList<NormalTweet>> {
        ...
        protected ArrayList<NormalTweet> doInBackground(String... search_parameters) {
            ...
            Log.i("passed query: ",query);
            // TODO Build the query
            Search search =  new Search.Builder(query).addIndex("testing").addType("tweet_test").build();
            ...
            try {
                ...
                if(result.isSucceeded()){
                    ...
                    Log.i("Error","The search query failed to find and tweets that matched");
                }
            }
            catch (Exception e) {
